...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        <h1 className='w-full text-3xl font-bold text-[#00df9a]'>@komilovsg</h1>
        <p className='py-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id odit ullam iste repellat consequatur libero reiciendis, blanditiis accusantium.</p>
        <div className='flex justify-between md:w-[75%] my-6'>
            <FaFacebookSquare size={30} className='hover:scale-105 transition-all hover:text-blue-600'/>
            <FaInstagram size={30} className='hover:scale-105 transition-all hover:text-pink-400'/>
            <FaTwitterSquare size={30} className='hover:scale-105 transition-all hover:text-blue-300'/>
            <FaGithubSquare size={30} className='hover:scale-105 transition-all hover:text-gray-500'/>
            <FaDribbbleSquare size={30} className='hover:scale-105 transition-all'/>
        </div>
      </div>
